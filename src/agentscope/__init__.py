...
def init(
    ...
    Args:
        ...
        logger_level (str, optional):
            The logging level. Defaults to ``"INFO"`` for a good balance
            of visibility during personal experiments. Use ``"WARNING"``
            to suppress routine messages or ``"DEBUG"`` for verbose output.
    """
